...
<div class="form-group col-sm-6">
    ...
    {!! Form::date('pay_regDate', $payment->pay_regDate, ['class' => 'form-control','id'=>'pay_regDate', 'required']) !!}
</div>
...
<div class="form-group col-sm-12">
  ...
  <select name="patients_id" id="patients_id" class="form-control selectpicker"  data-live-search="true" title="Select Patient" required>
...
<div class="form-group col-sm-12">
    ...
    {!! Form::text('pay_admission', null, ['class' => 'form-control price', 'required', 'oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"]) !!}
</div>

<!-- Pay Consultation Field -->
<div class="form-group col-sm-12">
    {!! Form::label('pay_consultation', 'Consultation Cost:') !!}
    {!! Form::text('pay_consultation', null, ['class' => 'form-control price', 'required', 'oninput'=>"this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"]) !!}
</div>
