...
<div class="form-group col-sm-12">
    ...
    {!! Form::text('ap_pxName', null, ['class' => 'form-control', 'required', 'onkeypress'=>"return /[a-z ]/i.test(event.key)"]) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('ap_doctor', null, ['class' => 'form-control', 'onkeypress'=>"return /[a-z ]/i.test(event.key)"]) !!}
</div>

<!-- Ap Specialist Field -->
<div class="form-group col-sm-6">
    {!! Form::label('ap_specialist', 'Preferred Specialization:') !!}
    {!! Form::text('ap_specialist', null, ['class' => 'form-control', 'onkeypress'=>"return /[a-z ]/i.test(event.key)"]) !!}
</div>
