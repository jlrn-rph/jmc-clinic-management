...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('px_regNumber', null, ['class' => 'form-control', 'maxlength'=>'10', 'required', 'autofocus required title'=>'Please enter numbers between 1 to 10 digits', 'pattern'=> '[0-9]{0,10}', 'onkeypress'=>"return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))"]) !!}
</div>
